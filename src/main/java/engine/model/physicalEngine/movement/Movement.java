...
public class Movement {
                ...
                if (shape2.isColliding()) {
                    ...
                    case UP -> {
                        if (apex.get(2).getY() - shape.getVelocity().getVelocityY() <= apex2.get(1).getY()
                                && apex.get(2).getX() > apex2.get(1).getX() && apex.get(0).getX() < apex2.get(3).getX()
                    ...
                    case DOWN -> {
                        if (apex.get(1).getY() + shape.getVelocity().getVelocityY() >= apex2.get(0).getY()
                                && apex.get(3).getX() > apex2.get(0).getX() && apex.get(1).getX() < apex2.get(2).getX()
                    ...
                    case RIGHT -> {
                        if (apex.get(2).getX() + shape.getVelocity().getVelocityX() >= apex2.get(0).getX()
                                && apex.get(3).getY() > apex2.get(0).getY() && apex.get(2).getY() < apex2.get(1).getY()
                    ...
                    case LEFT -> {
                        if (apex.get(1).getX() - shape.getVelocity().getVelocityX() <= apex2.get(2).getX()
                                && apex.get(1).getY() > apex2.get(0).getY() && apex.get(0).getY() < apex2.get(1).getY()
    ...
    /**
     * Update the X position of the Rectangle in the Map depending on whether the Rectangle will collide
     * or not
     *
     * @param direction : the Direction following by the Rectangle
     * @param shape     : the Rectangle in movement
    ...
    /**
     * Update the Y position of the Rectangle in the Map depending on whether the Rectangle will collide
     * or not
     *
     * @param direction : the Direction following by the @Rectangle
     * @param shape     : the Rectangle in movement
    ...
    public boolean updatePositonY(Direction direction, Rectangle shape, Map map) {
        ...
        if (direction == Direction.DOWN) {
            shape.setPosition(shape.getPosition().getX(),
                    obstacle.getY() - obstacle.getHeight() / 2 - shape.getHeight() / 2);
            return true;
        } else if (direction == Direction.UP) {
            shape.setPosition(shape.getPosition().getX(),
                    obstacle.getY() + obstacle.getHeight() / 2 + shape.getHeight() / 2 + 2);
            return true;
        }
        return false;
    }
