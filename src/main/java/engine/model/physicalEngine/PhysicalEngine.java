...
public class PhysicalEngine {
    ...
    public Rectangle addEntity(Position position, double width, double height, Color color, boolean isMoving, Velocity velocity) {
        Rectangle entity = new Rectangle(position, width, height, color, true, velocity);
